...
const UserAgreementReact = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-12 flex flex-col items-center min-h-screen rounded-lg ", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "pt-10 text-4xl font-bold text-gray-800", children: textUserAgreement.title }),
...
const $$UserAgreement = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": localeTextSite.pages.userAgreement.title, "description": localeTextSite.pages.userAgreement.description }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Container", $$Container, {}, { "default": ($$result3) => renderTemplate` ${renderComponent($$result3, "UserAgreementReact", UserAgreementReact, { "client:load": true, "client:component-hydration": "load", "client:component-path": "@ui/components/react-components/flatpages-react/user-agreement", "client:component-export": "default" })} ` })} ` })}`;
}, "/home/john/DevJohn/open-source-storelike-ui-admin/admin-host-app/src/pages/user-agreement.astro", void 0);

const $$file = "/home/john/DevJohn/open-source-storelike-ui-admin/admin-host-app/src/pages/user-agreement.astro";
